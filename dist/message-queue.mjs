import { DISCORD_MESSAGE_CHAR_LIMIT, fitDiscordPayload, messageFingerprint, moreEntriesLabel, } from './log-utils.mjs';
...
export class MessageQueue {
    ...
    prepareForSend(message) {
        return {
            ...message,
            description: fitDiscordPayload(message.description ?? '', message._repeatCount ?? 1, this.formatEnabled()),
        };
    }
    recordSent(messages) {
        const now = Date.now();
